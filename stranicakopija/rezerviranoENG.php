...
$message = '<center><h1 style="color:#333;font-weight:bold;" >MY RESERVATIONS</h1></center>';
echo $message;
...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<td><a href='delete-rez.php?ID_Rezervacija=".$row["ID_Rezervacija"]."'>Cancel</a></td>";
    echo "</tr>";
}
echo "</table>";
?>
