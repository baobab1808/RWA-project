...
<center>    <div class="wrapper" style="background:rgba(0,0,0,0.4); margin-top:60px; border-radius:25px; color:white;">
        <h2>Registration</h2>
        <p>Please complete this questionnaire to create an account</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Send" style="background-color:#00CCCC">
				<a class="btn btn-link" href="heheheENG.html" style="color:#00CCCC">Cancel</a>
                <!---<input type="reset" class="btn btn-default" value="Reset">--->
            </div>
            <p>Already have an account? <a href="login.php" style="color:#00CCCC">Login</a>.</p>
        </form>
    </div> </center>   
</body>
</html>
