...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: goodbyeENG.php");
    exit;
}
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                          ...
                          // Password is correct, so start a new session
							...
							header("location: hehehe_loggedENG.html");
...
<body>
 <center>   <div class="wrapper" style="background:rgba(0,0,0,0.4); margin-top:200px; border-radius:25px; color:white;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>You don't have an account? <a href="signupENG.php" style="color:#00CCCC">Sign up now</a>.</p>
