...
// Check if the user is already logged in, if yes then redirect him to rezervacija page
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                          ...
                          // Password is correct, so start a new session
                            ...
                            // Redirect user to rezervacija page
							header("location: rezervacijaENG.php");
 ...
 <center>   <div class="wrapper" style="background:rgba(0,0,0,0.4); margin-top:200px; border-radius:25px; color:white;">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
				...
				<a class="btn btn-link" onclick="history.back()" style="color:#00CCCC">Cancel</a>
            </div>
            <p>Don't have an account?<a href="signupENG.php" style="color:#00CCCC">Sign up now</a>.</p>
