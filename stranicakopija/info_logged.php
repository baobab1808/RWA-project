...
<div class="topnav" id="myTopnav">
  <a href="hehehe_logged.html">Naslovna</a>
  <a href="lokacija_logged.html" >Lokacija</a>
   <div class="dropdown">
    <button class="dropbtn">Smještaj 
      <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
	  <a href="mala_soba_logged.html">Mala Soba</a>
      <a href="velika_soba_logged.html">Velika Soba</a>
      <a href="apartman_logged.html">Apartman</a>
    </div>
  </div> 
  <a href="kontakti_logged.html" >Kontakti</a>
  <a href="info_logged.php" class="active">Informacije</a>
  <a href="rezervirano.php">Rezervirano</a>
  <div class="topnav-right">
	  <div class="dropdown">
		<button class="dropbtn" id="jezik1" style="float:right">Jezik
		  <i class="fa fa-caret-down"></i>
		</button>
		<div class="dropdown-content" id="jezik">
		  <a href="hehehe_loggedENG.html">ENG</a>
		</div>
	  </div> 
	  <a href="login.php">Odjava</a>
  </div>
...
<center><div style="background:rgba(255,255,255,0.7); border-radius:25px; width:700px">
	<h2 style="text-align:center; font-family:Decorative;"><b><i>Dodatna pitanja? Slobodno nam ih pošaljite!</i></b></h2>
	...
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="align:center">
		<div <?php echo (!empty($name_err)) ? 'has-error' : ''; ?>">
			<input type="text" name="name" size="54.85" placeholder="Ime" value="<?php echo $name; ?>" style="border-radius:15px;" required>
			<span><?php echo $name_err; ?></span>
		</div> 
		<br>
		<div <?php echo (!empty($surname_err)) ? 'has-error' : ''; ?>">
			<input type="text" name="surname" size="54.85" placeholder="Prezime" value="<?php echo $surname; ?>" style="border-radius:15px;" required>
		...
		<div <?php echo (!empty($text_err)) ? 'has-error' : ''; ?>">
			<textarea  name ="text" rows="25" cols="50" placeholder="Vaša poruka" value="<?php echo $text; ?>" style="border-radius:15px;" required></textarea>
		...
		<div>
			<input type="submit" name="submit" value="Pošalji" style="height:50px; width:100px; border-radius:10px; background-color:#00CCCC; color:black; font-weight:bold;" onClick="poruka_uspjeca">
		</div>
